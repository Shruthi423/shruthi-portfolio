  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          // Bare dot (no label / image): filled with the contrast tone
          // (--cursor-pill → ink, flipped to paper over the inverted footer via
          // .hero-active) so it turns dark on a light background and light on a
          // dark one, and stays visible. A thin opposite-tone ring keeps it
          // legible over mid-tone photos too. (mix-blend-difference was dropped:
          // it silently fails over ScrollSmoother's transformed home content.)
