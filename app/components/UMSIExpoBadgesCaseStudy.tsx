...
// Badge slots - one per category in the Expo. Each entry can point at an
// image OR fall back to a labelled placeholder until art is ready. Names
// are placeholders; replace as the final categories are confirmed.
const BADGES: { name: string; caption: string; file?: string }[] = [
  { name: "Badge 01", caption: "TBD - swap in the final artwork" },
  { name: "Badge 02", caption: "TBD - swap in the final artwork" },
  { name: "Badge 03", caption: "TBD - swap in the final artwork" },
  { name: "Badge 04", caption: "TBD - swap in the final artwork" },
];
